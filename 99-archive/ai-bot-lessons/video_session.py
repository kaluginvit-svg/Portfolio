"""
Отдельная ветка для пользователя: ожидание «промпта» для генерации видео Sora.
"""
...
class VideoPromptSession:
    """Пока чат в «режиме видео», обычный текст уходит в Sora, а не в чат."""
